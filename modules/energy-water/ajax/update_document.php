<?php
/**
 * AJAX: Update Document Info for Energy & Water
...
try {
    ...
    $module = isset($_POST['module']) ? $_POST['module'] : 'energy_water';
    ...
    if ($existingDoc) {
        ...
        logActivity($_SESSION['user_id'], 'update_document', "Updated document ID: $doc_id");
        ...
        logActivity($_SESSION['user_id'], 'create_document', "Created document ID: $doc_id");
    }
