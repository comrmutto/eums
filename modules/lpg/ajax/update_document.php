<?php
/**
 * AJAX: Update Document Info for LPG
...
try {
    ...
    $module = isset($_POST['module']) ? $_POST['module'] : 'lpg';
    ...
    if ($existingDoc) {
        ...
        logActivity($_SESSION['user_id'], 'update_document', "Updated LPG document ID: $doc_id");
        ...
        logActivity($_SESSION['user_id'], 'create_document', "Created LPG document ID: $doc_id");
    }
