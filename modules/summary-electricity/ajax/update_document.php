<?php
/**
 * AJAX: Update Document Info for Summary Electricity
...
try {
    ...
    $module = isset($_POST['module']) ? $_POST['module'] : 'summary';
    ...
    if ($existingDoc) {
        ...
        logActivity($_SESSION['user_id'], 'update_document', "Updated summary document ID: $doc_id");
        ...
        logActivity($_SESSION['user_id'], 'create_document', "Created summary document ID: $doc_id");
    }
